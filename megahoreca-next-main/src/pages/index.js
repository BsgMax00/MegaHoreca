    ...
    <>
      ...
      {prodata && catdata &&
        <>
          ...
          <Advertisement />
          <MasonrySection title="Meest verkochte producten" prodata={prodata} catdata={catdata} />
          <CategoryListSmall prodata={prodata} catdata={catdata} />
          <SlickCarouselSection title="Producten met de grootste kortingen" prodata={prodata} catdata={catdata} />
