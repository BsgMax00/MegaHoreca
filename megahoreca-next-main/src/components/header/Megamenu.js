                                                        ...
                                                        {cat.subcategory.map(sub =>
                                                            <Col key={sub.id} lg={3} sm={4}>
                                                                <Card className="text-white">
                                                                    <Card.Img src={sub.img} alt="Image not available" width={400} height={200}/>
                                                                    <Link href={`/${sub.slug}`}>
                                                                        <a className='link-dark'>
                                                                            <Card.ImgOverlay className='d-flex align-items-center justify-content-center'>
                                                                                <Card.Title as="p" className='text-center text-white fw-bold small mb-0 p-2 category-card'>
                                                                                    {sub.title}
                                                                                </Card.Title>
                                                                            </Card.ImgOverlay>
                                                                        </a>
